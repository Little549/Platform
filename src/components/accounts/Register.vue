  ...
  <div class="register">
    ...
    <el-form class="register-form" label-width="100px" :model="formMessage" :rules="rules" size="mini">
      ...
      <el-form-item label="用户名:" prop="username">
        <el-input type="text" placeholder="用户名不得小于5位" v-model="formMessage.username"></el-input>
      </el-form-item>

      <el-form-item label="密码:" prop="password">
        <el-input type="password" placeholder="密码不得小于5位" v-model="formMessage.password"></el-input>
      </el-form-item>
      ...
      this.$http.post('/users/', obj) // 将信息发送给后端
        .then((res) => { // axios返回的数据都在res.data里
          ...
          if (res.status === 201) { // 如果成功
            // 本地存储用户信息
            cookie.setCookie('user_type', 1, 7)
