<template>
  <div class="check-activity">
    ...
    <el-row class="checkActivity-form-back">
      <el-form class="checkActivity-form-one" label-width="150px" :model="formMessage" size="mini">
    ...
    <el-row class="checkActivity-form-back">
      活动详情
      <el-form class="checkActivity-form-two" label-width="150px" :model="formMessage" size="mini">
    ...
    <el-row class="checkActivity-form-back">
      ...
      <el-form class="checkActivity-form-two" label-width="150px" :model="formMessage" size="mini">
        ...
        <el-form-item>
          <el-button @click="editActivity" type="primary" size="medium">编辑</el-button>
          <el-button @click="onCertain" type="primary" size="medium">确定返回</el-button>
        </el-form-item>
      </el-form>
    </el-row>
  </div>
...
export default {
  ...
  methods: {
    ...
    // 跳转活动编辑
    editActivity () {
      this.$router.push({name: 'ModifyActivity', params: {id: this.$route.params.id, page: this.$route.params.page}})
    },
    onCertain () {
...
<style scoped>
  .checkActivity-form-back {
    border-radius: 5px;
    background: rgba(210, 210, 210, 0.1);
    margin-top: 10px;
  }
  .checkActivity-form-one {
    width: 700px;
    /*margin: 30px auto;*/
    margin-top: 30px;
  }
  .checkActivity-form-two {
    width: 700px;
    /*margin: 30px auto;*/
    margin-top: 10px;
  }
